...
### 3.1.2 One proportion test (three or more outcome categories)
...
### 3.2.2 Two proportion test (three or more outcome categories)
...
## 3.3 Three or more proportion tests (compare more than two samples)
